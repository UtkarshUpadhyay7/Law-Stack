...
📚 LawLens — AI-Powered Legal Search Engine (RAG-Based)



LawLens is an AI-powered legal assistant designed to simplify Indian laws for common citizens using a Retrieval-Augmented Generation (RAG) architecture.
